...
const Abas = () => {
    return (
        <>
            <div>
                <div className="flex gap-3 w-[19px] h-[19px] mt-[75px] mb-[55px] ml-[50px]">
                    <img src={IconeFiltro} alt="Icone" />
                    <p>Filtros</p>
                </div>
            </div>
            <div className='w-[394px] border border-black/15 rounded-tl-[12px] rounded-tr-[12px] overflow-hidden mb-[50px]'>
                <div className="flex bg-black/15 mb-">
